...
+ [Manual del usuario](manualPellin.pdf)

--------
## Capítulos de libro

+ **Salas-Eljatib C**, Fuentes A, Donoso PJ, Matus C, Soto D. 2018. [Crecimiento de bosques secundarios y adultos de
Nothofagus en el centro-sur de Chile](http://eljatib.com/myPubs/2018_CreciNotho_libro_Donoso_etal_Silvicultura_Bosques_Nativos.pdf). *In*: Silvicultura en bosques nativos: experiencias en silvicultura y restauración 
...
+ **Salas C**, Real P. 2013. [Biometría de los bosques naturales de Chile: estado del arte](http://eljatib.com/myPubs/2013capiBiometriaBNativos.pdf).
