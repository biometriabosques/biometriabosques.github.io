...
Existen diversas aproximaciones para modelar el crecimiento de bosques [@munro74;@aaronbook;@salasmodcreci]. *Pellín* adopta el enfoque
de modelo de crecimiento de arbol individual independiente
de la distancia.
...
El diagrama de la figura 2 describe el flujo básico de 
 un sistema de simulación de crecimiento
  forestal a nivel individual, como por ejemplo 
  el de *Pellín*. Lo primero
...
de tamaño de un bosque (i.e., lista de árboles),
 define la estructura de este, representandola mediante variables de rodal agregada y de orden, y 
  variables que definen la competencia. Posteriormente,
   ...
   respectivas tasas de cambio para el siguiente ciclo. De esta manera se genera una nueva lista de árboles que entra a un nuevo ciclo.
 
| ![](img/flujoPellin1.png) |
|:--:|
